require(['jquery'], function ($) {
    ...
    function onResize(){
        ...
        p2Trigger = $p2.offset().top + $p2.height() / 2;
    ...
    function moveParallax() {
        ...
        if (!p2Entered && $win.scrollBottom() > p2Trigger) {
            TweenLite.to($p2Screen, ANIMATION_DURATION, {autoAlpha: 1});
        }
    }

    // hide all elements since javascript is enabled...
    TweenLite.set($p2Screen, {autoAlpha: 0});
